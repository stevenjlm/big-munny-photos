...
export function Calculator() {
  ...
  return(
    <div>
      <h1 className='text-mybase-900 py-6 readhit'>Calculator:</h1>
      <div className='flex justify-between items-center px-8 py-6 mr-8'>
        <div className='w-2/5'>
          <label className="block mb-2 readhit font-medium text-mybase-900">Hours of photography: {sHours}</label>
        ...
        <div className='w-2/5'>
          <label className="block mb-2 readhit font-medium text-mybase-900">Minutes of Driving**: {dHours}</label>
      ...
      <div className='flex justify-between items-center px-8 py-6 mr-8'>
        ...
        <label className="block mb-2 readhit font-medium text-mybase-900">Total Cost:</label>
        <div className="relative mb-6">
          ...
          <input className="pl-10 p-2.5 rounded-xl border-red text-mybase-900 readhit font-bold" readOnly value={computeTotal()}/>
        </div>
      </div>
      <p className='text-mybase-900 readhit'>** One-way from Oakland, CA</p>
    </div>
  )
